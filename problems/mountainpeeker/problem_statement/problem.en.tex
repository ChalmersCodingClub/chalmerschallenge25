...
\illustration{0.5}{mountains.png}{Illustration of sample 4. Joel can see all mountain peaks except the left-most and the right-most ones.
Please note that the positions of the valleys are arbitrary, and you only need to consider the positions of the peaks to solve the problem.}
